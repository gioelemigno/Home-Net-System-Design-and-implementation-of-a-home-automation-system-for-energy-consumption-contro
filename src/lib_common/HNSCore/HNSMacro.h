...
//	Set:	(they are used by master)
	...
	//	Other types	:
	#define RESPONSE_0							185			//it used by slave to give a
...
/***************************** STANDARD TYPE **********************************/
	...
	#define SET_STATUS_ON   SET_31
    #define SET_STATUS_OFF  SET_30

	//master ask only changes
	#define REFRESH 			READ_31
	#define REFRESH_ALL 		READ_30
	//response to REFRESH when only chip temperature changed
	#define RSP_ONLY_TEMP 			RESPONSE_31
	
	//response to REFRESH when nothing changed
	#define RSP_NO_CHANGE 		RESPONSE_30

	//indicates number of sub thing inside data (not considering chip_temperature)
	// in this case, there is always chip_temperature !!!
	// For example, in HNSocketPOwer, indicates number of subSocket 
	#define RSP_REFRESH_1		RESPONSE_29
	#define RSP_REFRESH_2		RESPONSE_28	
	#define RSP_REFRESH_3		RESPONSE_27
	#define RSP_REFRESH_4		RESPONSE_26
	
	//response to REFRESH_ALL 
	#define RSP_REFRESH_ALL				RESPONSE_25

	#define RSP_SET_STATUS_ON		RESPONSE_24
	#define RSP_SET_STATUS_OFF		RESPONSE_23
	#define RSP_SET_STATUS_ALLARM 	RESPONSE_22
/******************************************************************************/
